...
public class homepage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton konsolidasi = (ImageButton) findViewById(R.id.bt8);
        konsolidasi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent b_konsolidasi = new Intent(homepage.this,persyaratan.class);
                startActivity(b_konsolidasi);
            }
        });
    }
}